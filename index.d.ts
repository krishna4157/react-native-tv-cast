...
// Definitions by: Krishna Santosh
...
declare class TVCast {
   ...
   * @deprecated - Use the static method TVCast.setCategory('Playback') instead which has the same effect.
   * @param enabled
   */
