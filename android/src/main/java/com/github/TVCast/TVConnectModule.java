...
public class TVConnectModule extends ReactContextBaseJavaModule implements AudioManager.OnAudioFocusChangeListener {
  ...
  public TVConnectModule(ReactApplicationContext context) {
    super(context);
  ...
  public void prepare(final String fileName, final Double key, final ReadableMap options, final Callback callback) {
    ...
    final TVConnectModule module = this;
    ...
    if (module.category != null) {
      ...
      switch (module.category) {
        ...
        case "Alarm":
          ...
          break;
        default:
          Log.e("TVConnectModule", String.format("Unrecognised category %s", module.category));
          break;
      }
      if (category != null) {
    ...
    player.setOnPreparedListener(new MediaPlayer.OnPreparedListener() {
      ...
      public synchronized void onPrepared(MediaPlayer mp) {
        ...
        try {
          ...
          Log.e("TVConnectModule", "Exception", runtimeException);
        }
      }
    ...
    try {
      ...
      Log.e("TVConnectModule", "Exception", ignored);
    }
  }
  ...
  protected MediaPlayer createMediaPlayer(final String fileName) {
    ...
    if (res != 0) {
      try {
        ...
        Log.e("TVConnectModule", "Exception", e);
        return null;
      }
      return mediaPlayer;
    }
    ...
    if (fileName.startsWith("http://") || fileName.startsWith("https://")) {
      ...
      Log.i("TVConnectModule", fileName);
      try {
  ...
  public void setSpeed(final Double key, final Float speed) {
	if (android.os.Build.VERSION.SDK_INT < 23) {
	  Log.w("TVConnectModule", "setSpeed ignored due to sdk limit");
	  return;
	}
  ...
  public void setPitch(final Double key, final Float pitch) {
    if (android.os.Build.VERSION.SDK_INT < 23) {
      Log.w("TVConnectModule", "setPitch ignored due to sdk limit");
      return;
    }
